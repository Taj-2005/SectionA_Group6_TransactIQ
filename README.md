...
SectionA_Group6_DVA/
  ...
  data/
    raw/
      (raw source files go here; currently placeholders)
    processed/
...
- **`data/raw/`**: the original dataset files (or a reproducible download script/notebook). Keep these **unchanged** once selected.
